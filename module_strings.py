...
Poisonous herbs can also sometimes be found, which are then applied to the blades of certain weapons used for murderous deeds; they have many brown stalks covered in tiny green leaves."),
  ...
  ("backend_link" , "http://127.0.0.1/KORANGAR2020"),
  ("script_pass" , "1234"),
  ...
  ("local_chat_me_log_format", "[ME] {s31}"), # leolynn Me komutu
  ("local_chat_do_log_format", "[DO] {s31}"), # leolynn Do komutu
  ("local_chat_whisper_log_format", "[FISIL] {s31}"), # leolynn Whisper komutu
  ("local_chat_ooc_log_format", "[OOC] {s31}"), # leolynn OOC komutu
  ("ash_help_prefix", "Awadion RPG - Komutlar ^ --------------------------"), # leolynn Yardim komutu
